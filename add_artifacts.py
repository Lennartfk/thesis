...
Usage:
    python add_artifacts.py <experiment_name> <run_id> <file_or_dir_path> [additional_paths...]
    python add_artifacts.py --list-experiments
    python add_artifacts.py --list-runs <experiment_name>
"""
...
Examples:
  ...
  python add_artifacts.py --list-runs seedvig_loso

  # Add a file to a run
  python add_artifacts.py seedvig_loso abc123def456 ./my_file.csv

  # Add multiple files
  python add_artifacts.py seedvig_loso abc123def456 ./file1.csv ./file2.png ./output_dir/

    # Delete artifact path(s) from a run
    python add_artifacts.py seedvig_loso abc123def456 --delete-artifact confusion_matrix.png
    python add_artifacts.py seedvig_loso abc123def456 --delete-artifact plots --delete-artifact tables/fold_metrics.csv
        """,
    )
